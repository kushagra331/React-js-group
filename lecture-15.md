...
* setTimeout(), DOM APIs, fetch(), localstorage, console (yes, even console.log is not part of JavaScript!!), location and so many more are not part of JavaScript. These all are Web APIs.
    * setTimeout() : Timer function
    * DOM APIs : ex>Document.getElementByID ; Used to access HTML DOM tree. (Document Object Manipulation)
